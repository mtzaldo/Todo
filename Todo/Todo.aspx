<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Todo.aspx.cs" Inherits="Todo.Todo" %>
    ...
    <div>
        ...
        <asp:GridView runat="server" ID="grvTodo" AutoGenerateColumns="false"  DataKeyNames="ID" ShowHeader="false" GridLines="None"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:Button runat="server" ID="btnEdit" Text="!" CommandName="edit" />
                        <asp:Button runat="server" ID="btnSave" Text="#" CommandName="update" />
                        <asp:Button runat="server" ID="btnDelete" Text="x" CommandName="delete" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <EmptyDataTemplate>
